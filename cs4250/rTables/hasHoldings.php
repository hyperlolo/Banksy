...
?>
<link rel="stylesheet" type="text/css" id="applicationStylesheet" href="./rTables.css"/>

<head>
    <title>hasHoldings|Relation Table|Banksy</title>
</head>
...
<div id="canWithdraw">
    ...
    <span>For any questions or concerns please contact us <a href="mailto:kgill15@csustan.edu?&cc=ggarciadeleon@csustan.edu;cguptail@csustan.edu&subject=hasHoldings%20Relation%20Table" style="color: inherit;"target="_blank">HERE</a></span>
    </footer>
    <div id="Canwithdraw">
		<span>hasHoldings</span>
	</div>
    <div id="Query__SELECT___FROM__canWithd">
        <span>SELECT * FROM 'hasHoldings';</span><br><br>
...
<head>
    <title>CS4250- Banksy: Relationship Tables</title>
    <link rel="stylesheet" href="../style.css">
</head>

<body>
    <header>
        <div id="logo">hasHoldings</div>
        <nav>
            <ul>
    ...
    <footer>
        <p>For any questions or concerns please contact me <a href="mailto:kgill15@csustan.edu">HERE</a></p>
    </footer>
</body>
