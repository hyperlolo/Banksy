...
<head>
    <title>processTransactions|Relation Table|Banksy</title>
</head>
...
<div id="canWithdraw">
    ...
    <span>For any questions or concerns please contact us <a href="mailto:kgill15@csustan.edu?&cc=ggarciadeleon@csustan.edu;cguptail@csustan.edu&subject=processTransactions%20Relation%20Table" style="color: inherit;"target="_blank">HERE</a></span>
    </footer>
    <div id="Canwithdraw">
		<span>processTransactions</span>
	</div>
    <div id="Query__SELECT___FROM__canWithd">
        <span>SELECT * FROM 'processTransactions';</span><br><br>
    ...
    <section id="results">
        <main role="main">
            <article>
                ...
                $sql = "SELECT * FROM `processTransactions`;";
...
<head>
    <title>Transactions - Banksy</title>
