...
<div id="canWithdraw">
    ...
    <div id="Group_235">
        ...
        <div id="Home">
            <span><a target="_self" href="/~kgill/index.php" style="text-decoration: underline;color: inherit; link: black;">Home</a></span>
        </div>
    ...
    <div class="wrapper" style="margin">
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . formatPhone($row['phoneNumber']) . "</td>";
                                        echo "<td>";
                                            echo "<a href='read.php?Employee_ID=". $row['employeeID'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
    ...
    <footer style="position: absolute; left: 1424px; top: 196px; overflow: visible; width: 400px; display: block; text-align: center; font-family: Poppins; font-style: normal; font-weight: bold; font-size: 25px; color: rgba(0,0,0,1); word-wrap: break-word; letter-spacing: 0.4px;">

    <span style="color: black">For any questions or concerns please contact us <a href="mailto:kgill15@csustan.edu?&cc=ggarciadeleon@csustan.edu;cguptail@csustan.edu&subject=CRUD" style="color: inherit; text-decoration: underline;"target="_blank">HERE</a></span>
    </footer>
</html>