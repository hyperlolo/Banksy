...
<head>
    <title>Senior Managers|Query List|Banksy</title>
</head>
...
<div id="canWithdraw">
    ...
    <span>For any questions or concerns please contact us <a href="mailto:kgill15@csustan.edu?&cc=ggarciadeleon@csustan.edu;cguptail@csustan.edu&subject=BankInfo%20Query%20List" style="color: inherit;"target="_blank">HERE</a></span>
    </footer>
    ...
    <div id="Query__SELECT___FROM__canWithd">
        <span>SELECT E.firstName, M.typeOfManager FROM Manager M, Employee E WHERE M.employeeID=E.employeeID and E.age > 30;</span><br><br>
        <p>A manager may want to see who are the other senior managers at the banks.</p>
        <hr>
        <p>Finds out the first name, the type of manager, and who is over the age of 30</p>
    </div>


    <section id="results" style="top:450px";>
        <main role="main">
        <article>                
            <?php
            ...
            $sql = "SELECT E.firstName, M.typeOfManager FROM Manager M, Employee E WHERE M.employeeID=E.employeeID and E.age > 30;";
